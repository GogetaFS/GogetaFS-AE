...
FILE_SYSTEMS=( "Light-Dedup-J-64bits-disable-dedup" "NOVA-Improve")
TIMERS=( "fio_nova.sh" "fio_nova.sh" )
SETUPS=( "setup_nova.sh""setup_nova.sh" )
BRANCHES=( "light-fs-dedup-disable-dedup" "nova-pipe" )

# FILE_SYSTEMS=( "Light-Dedup-Improve" )
# TIMERS=( "fio_nova.sh" )
# SETUPS=( "setup_nova.sh" )
# BRANCHES=( "nova-pipe-dedup" )
