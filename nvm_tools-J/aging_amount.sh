...
if [ ! $3 ]; then
	echo Usage: $0 num_of_threads size dup_rate branch_name aging_size aging_hole block_size pmem_id
	exit 1
fi
...
sudo "$ABSPATH"/aging_system -d /mnt/pmem0 -s $5 -o $6 -b $7 -p 1
...
# phase 2
sudo "$ABSPATH"/aging_system -d /mnt/pmem0 -s $5 -o $6 -b $7 -p 2
...
sudo "$ABSPATH"/aging_system -d /mnt/pmem0 -s $5 -o $6 -b $7 -p 3
